...
interface ModifyTournamentFormProps {
  tournamentId: string;
...
const ModifyTournamentForm: React.FC<ModifyTournamentFormProps> = ({tournamentId, tournamentName, tournamentDescription, deadline, startDate, maxParticipants, tournamentType, fishType, refreshData}) => {
...
export default ModifyTournamentForm;
