...
import { DataTableRowActions } from "@/components/dataTables/allCatchTable/RowActions"
...
export const columns: ColumnDef<CatchInLogBookSchema | undefined>[] = [
  ...
  },
  {
    ...
    cell: ({ row, table, column}) => <DataTableRowActions table={table} row={row} column={column} fishImageUrl={row.getValue("fishImageUrl")} fishName={row.getValue("fishName")} />,
  },
]