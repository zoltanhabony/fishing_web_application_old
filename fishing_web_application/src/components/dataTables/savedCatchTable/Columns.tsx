...
import { DataTableColumnHeader } from "@/components/dataTables/savedCatchTable/ColumnHeader"
import { DataTableRowActions } from "@/components/dataTables/savedCatchTable/RowActions"
...
export const columns: ColumnDef<CatchInLogBookSchema | undefined>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Fajta" />
    ),
    cell: ({ row }) => {
      return (
  ...
  },
  {
    ...
    cell: ({ row }) => <DataTableRowActions row={row} fishImageUrl={row.getValue("fishImageUrl")} fishName={row.getValue("fishName")}/>,
  },
]